# Generated by Django 3.2.13 on 2022-05-29 17:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.TextField(verbose_name='Описание поста')),
                ('pub_date', models.DateField(auto_now_add=True, verbose_name='Дата создания')),
                ('is_favorite', models.BooleanField(default=False, verbose_name='Добавить в избранное')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='favorites', to='api.post', verbose_name='Пост')),
